...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseNpgsql("Host=192.168.1.32;Port=5432;Database=aysanrafpopsepdevelopment_2023_09_10_05_45;\nUsername=postgres;Password=15051505;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PlannedOfferForm>(entity =>
            {
                ...
                entity.Property(e => e.AccommodationTotalPrice).HasMaxLength(19);

                entity.Property(e => e.AccommodationUnitPrice).HasMaxLength(18);
                ...
                entity.Property(e => e.DailyTonnage).HasMaxLength(36);

                entity.Property(e => e.DailyWageCost).HasMaxLength(19);

                entity.Property(e => e.EquipmentShipmentCost).HasMaxLength(18);

                entity.Property(e => e.ExchangeRate).HasMaxLength(19);

                entity.Property(e => e.FieldEngineerCost).HasMaxLength(19);

                entity.Property(e => e.FuelAmount).HasMaxLength(36);

                entity.Property(e => e.FuelTotalCost).HasMaxLength(36);

                entity.Property(e => e.FuelUnitPrice).HasMaxLength(19);

                entity.Property(e => e.InstallationTotalCost)
                    .HasMaxLength(36)
                    .HasColumnName("InstallationTotalCost ");

                entity.Property(e => e.InstallationTotalCostCurrency).HasMaxLength(36);

                entity.Property(e => e.IsgexpertCost)
                    .HasMaxLength(18)
                    .HasColumnName("ISGExpertCost");

                entity.Property(e => e.NumberTrucksUsed).HasColumnType("character varying(19)[]");

                entity.Property(e => e.OfferTonnage).HasMaxLength(36);

                entity.Property(e => e.RentedCarUnitPrice).HasMaxLength(19);

                entity.Property(e => e.RentedCarUnitTotalPrice).HasMaxLength(36);

                entity.Property(e => e.RentedEquipmentId).HasMaxLength(36);

                entity.Property(e => e.RentedEquipmentName).HasMaxLength(36);

                entity.Property(e => e.SalesOfferNumber).HasMaxLength(36);

                entity.Property(e => e.ShippingTotalCost).HasMaxLength(19);

                entity.Property(e => e.ShippingTotalCostCurrency).HasMaxLength(19);

                entity.Property(e => e.StaffMealTotalPrice)
                    .HasMaxLength(19)
                    .HasColumnName("StaffMealTotalPrice ");

                entity.Property(e => e.StaffMealUnitPrice)
                    .HasMaxLength(18)
                    .HasColumnName("StaffMealUnitPrice ");

                entity.Property(e => e.TruckUnitPrice).HasMaxLength(19);
            ...
            modelBuilder.Entity<RealizedOfferForm>(entity =>
            {
                ...
                entity.Property(e => e.NumberTrucksUsed).HasMaxLength(19);

                entity.Property(e => e.OfferTonnage).HasMaxLength(36);

                entity.Property(e => e.RentedCarAmount).HasMaxLength(36);
